                ...
                <Container>
                    <Row>
                        ...
                        <Col>
                            ...
                            <Row>
                                <Col>
                                    <input type="text" style={{fontSize:'32px'}} onChange={(e) => { this.setState({ groupName: e.target.value }); this.setState({ open: true }) }} name="groupName" id="groupName" placeholder="Funkytown" required />
                                </Col>
                            </Row>
                            <hr/>
